...
<form action="" method="post">
  <h2>add offer:</h2>
  <p>scheme:
    <input type="text" name="scheme" placeholder="Enter scheme to add"></p><br>
  <p>minmum amount:
  <input type="text" name="min" placeholder="Enter the minmum amount for offer"></p><br>
  <p>reward:
  <input type="text" name="reward" placeholder="Enter the reward for offer"></p><br>
