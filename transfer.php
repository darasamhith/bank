...
<form action="" method="post">
  <h2>Transfer to:</h2>
  <p>Account no:
    <input type="text" name="account" placeholder="Enter Account no to transfer "></p><br>
  <p>Amount:
  <input type="text" name="amount" placeholder="Enter Amount to transfer"></p><br>
  <input type="submit" name="submit">
</form>
<span><?php
echo $_SESSION['suc']; ?></span>
</div>
